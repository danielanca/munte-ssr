        ...
        <Card>
          <div className={classes.account}>
            <div className={classes.img_wrapper}>
              <img className={classes.avatar} src={props.customer?.avatar} alt='customer avatar' />
            </div>
      ...
      <div className={classes.edit__right}>
        <Card>
          <div className={classes.account}>
            ...
            >
              <Input id='userName' type='text' placeholder={props.customer?.userName} />
              <Input
                id='phoneNumber'
                type='tel'
                minLength={7}
              ...
              />
              <Input id='email' type='email' placeholder={props.customer?.email} />
              <Input id='address' type='text' minLength={10} placeholder={props.customer?.location} />
